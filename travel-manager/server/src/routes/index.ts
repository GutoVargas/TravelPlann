...
apiRouter.get('/routes', searchCtrl.routesCtrl)
apiRouter.get('/google-status', searchCtrl.googleStatusCtrl)

apiRouter.get('/suggest-places', searchCtrl.suggestPlacesCtrl)
